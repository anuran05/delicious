...
import breadcumb2 from './img/bg-img/breadcumb2.jpg';
...
function ContactUs() {
  return (
    ...
    <div class="breadcumb-area bg-img bg-overlay" style={{backgroundImage: `url(${breadcumb2})`}}>
    </div>
   {/*  <!-- ##### Breadcumb Area End ##### -->
                ...
                <div class="col-12 col-lg-4">
                    <div class="blog-sidebar-area">
                        ...
                        <div class="single-widget mb-80">
                            ...
                            {/* <!-- Form --> */}
                            <div class="newsletter-form bg-img bg-overlay" style={{backgroundImage: `url(${bg1})`}}>
                                <form action="#" method="post">
